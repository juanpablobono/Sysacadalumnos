...
public class MainActivity extends ActionBarActivity {
	...
	private String[] descripciones = {
			"Calificaciones de las materias que estás cursando",
			"Para saber todo lo que pasa en la UTN",
			"Todas las fechas importantes que un UTNeano debe saber",
			"Solicitudes, trámites y mucho más",
			"Todo lo que debes saber al estar en la UTN",
			"Porque queremos conocerte", "Una vuelta de tuerca a la aplicación" };
	...
	private void cerrarSesion() {
		if (alumno.getPassword() != null) {
			...
			Toast.makeText(MainActivity.this,
					"La sesión se cerró correctamente", Toast.LENGTH_SHORT)
					.show();
			getSupportActionBar().setSubtitle("Ninguna sesión iniciada");
		} else {
			Toast.makeText(MainActivity.this, "No hay ninguna sesión iniciada",
