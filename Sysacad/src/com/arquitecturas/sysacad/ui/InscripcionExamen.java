...
public class InscripcionExamen extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_inscripcion_examen);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		// getMenuInflater().inflate(R.menu.inscripcion_examen, menu);
		return true;
	}
